...
depthflow_image = (
    ...
    # removed; pin to 1.6.3 (the last pre-1.92 release the mirror has — versions jump
    # 1.6.3 -> 1.92.0 — and the era depthflow 0.9.0.dev1 was built against).
    .pip_install("imgui-bundle==1.6.3")
)
